          ...
          <div :class="{on:!isSmsLogin}">
            <section>
              ...
              <section class="login_message">
                ...
                <img class="get_verification" src="http://localhost:8081/kaptcha/captcha-image" alt="captcha" @click="changeCaptcha">
              </section>
            </section>
          </div>
...
<script>
  ...
  export default {
    ...
    methods:{
       ...
       */
      changeCaptcha(event){
        event.target.src = "http://localhost:8081/kaptcha/captcha-image?time="+new Date();
      },
      /**
       * 发送短信验证码
       */
      ...
      async login(){
        ...
        if (this.isSmsLogin) {
          ...
          let user = await reqPwdLogin({name,pwd:password,captcha});
          console.log(user);
