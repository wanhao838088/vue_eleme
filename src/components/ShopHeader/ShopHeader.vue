  ...
  <div class="shop-header">
    ...
    <div class="activity-sheet" v-show="supportShow">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item" v-for="(ifo,index) in info.supports" :class="activitiyClasses[ifo.type]">
            <span class="content-tag">
            <span class="mini-tag">{{ifo.name}}</span>
            </span>
            <span class="activity-content">{{ifo.content}}</span>
          </li>
        </ul>
...
<script>
  ...
  export default {
    data(){
      return{
        activitiyClasses:['activity-red','activity-orange','activity-green'],
        shopShow: false,
        supportShow: false
      }
    },
